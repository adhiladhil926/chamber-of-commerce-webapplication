  ...
  const plans = [
    {
      ...
      features: [
        ...
        "✔️ Right to participate in all programmes conducted by the Chamber.",
        ...
        "✔️ Right to receive guidance, support and assistance",
                "⭐ Keralanadham E-paper Subscription (One year)",
      ],
    },

    {
      ...
      features: [
        ...
        "✔️ Right to receive guidance,support and assistance from the Chanber.",
         "⭐ Keralanadham E-paper Subscription (6 Months)",
              "⭐ All monthly Publications / magazines will be sent to the members"
      ],
    },

    {
      ...
      features: [
        ...
        "✔️  Regular updates and information shared from time to time.",
        "✔️ Right to receive guidance,support and assistance from the Chanber.",
                "⭐ Keralanadham E-paper Subscription (3 Months)",
            "⭐ All monthly Publications / magazines will be send to the members",
      ],
    },

    {
      ...
      features: [
        ...
        "✔️  Regular updates and information shared from time to time.",
        "✔️ Right to receive guidance,support and assistance from the Chanber.",
          "⭐ All monthly Publications / magazines will be send to the members through online",
